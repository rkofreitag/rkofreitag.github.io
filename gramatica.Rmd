...
Aqui resumo minha exposição no eixo **Gramática e variação linguística**. O detalhamento desta discussão aparece no capítulo [O tratamento da variação linguística na escola para o combate à discriminação e ao preconceito](https://www.researchgate.net/publication/373438573_O_tratamento_da_variacao_linguistica_na_escola_para_o_combate_a_discriminacao_e_ao_preconceito), publicado no livro *Linguística na educação básica*.
...
```{r, out.width = "70%", echo=FALSE}
library(knitr)
include_graphics("https://minio.scielo.br/documentstore/1678-460X/NkPrppB9TTHzLzv56ys97SB/27c574de3bd4fb11dc96f8c23ebbd1c6cfae4b1f.jpg")
```
